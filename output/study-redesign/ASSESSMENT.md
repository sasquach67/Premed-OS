...
The raw Mastery packet has five objectives, while the saved build has eight. Counts alone cannot establish completeness. A saved accessibility capture covers objectives 1–6: the first three raw objectives are split into finer gene-expression/translation objectives, and folding is objective 6. The capture ends before objectives 7–8. Full saved Mastery text was not exported; no claim of complete Mastery equivalence is made. Raw trailing provenance labels in the captured study sentences are hidden by the renderer, while structured sources remain accessible.
