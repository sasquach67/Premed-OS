...
createRoot(document.getElementById('root')!).render(<React.StrictMode><HashRouter><ToastProvider><div style={{fontSize:12,padding:'8px 24px',borderBottom:'1px solid var(--border)',display:'flex',justifyContent:'space-between',gap:16,flexWrap:'wrap'}}><span>Local design review / Actual Class Hub and notebook components / Invented data</span><Link to={`/academics/classes/${id}`}>Return to class notebook</Link></div><main className="min-h-screen p-3 sm:p-6"><Routes><Route path="/academics/classes/:courseId" element={<Hub />} /><Route path="/academics/classes/:courseId/journal/:entryId" element={<JournalEntryPage />} /><Route path="/academics/classes/:courseId/lectures/:entryId" element={<JournalEntryPage />} /><Route path="*" element={<ClassCards />} /></Routes></main></ToastProvider></HashRouter></React.StrictMode>)
