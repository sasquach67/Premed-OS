...
| D9-OCR | **Image OCR for scanned syllabi** | Syllabus ingestion | deferred | Browser OCR is deliberately deferred: Tesseract-class engines are multi-megabyte and slow. A detected scan names the limitation and keeps paste-text and manual entry available. |
