...
BUILD='notebook-instructions-beta-12'
...
def build_packet(out, source_root=None):
    ...
    checklist=['# Manual cross-provider checklist',NOTICE,'Release remains paused. Record actual results below; all result cells intentionally start blank. Use the SAME complete beta-12 goal prompt, request values, source files and turn sequence for each provider. The packet is one shared fixture set, not an extra maintained prompt.',
