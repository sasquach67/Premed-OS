...
Authored cases cover default direct delivery, explicit draft-only work, change-and-export, interrupted intake, complete versus truncated repair, missing scope and saved-baseline conflicts. They also cover local Downloads, hosted attachments, no-file fallback and coherent titled image bundles. These are deterministic expectations, not provider trials or student ratings.
