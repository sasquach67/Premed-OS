...
/** Matches the newest migration in `migrateAll`: `migrateRequirementsAuditV30`. */
export const CURRENT_STORE_VERSION = 30
...
export function migrateAll(data: AppData): AppData {
  ...
  return migrateRequirementsAuditV30(migrated)
}
