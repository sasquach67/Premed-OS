  ...
  return <section className="external-notebook en-flow" aria-label="External AI notebook workflow">
    ...
    {step === 'handoff' && <div className="en-stage-content">
      ...
      <ol className="en-handoff-list">
        ...
        <li><span className="en-task-number" aria-hidden="true">3</span><div><h2>Download your notebook</h2><p>Save the <strong>JSON file</strong> and any accompanying <strong>images</strong>. Keep their filenames unchanged.</p></div></li>
      </ol>
      <details className="en-brief-note en-handoff-help">
        ...
        <dl>
          ...
          <div><dt>Finding your downloads</dt><dd>Check your browser's download list or chosen download folder. If your AI cannot offer a file, copy the complete JSON code block and use “Paste JSON instead” on the import screen. A text-only notebook needs only its JSON.</dd></div>
      ...
      <div className="en-gate">
        <div><p className="en-gate-title">Have your JSON and images ready?</p></div>
