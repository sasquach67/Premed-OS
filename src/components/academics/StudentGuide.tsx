...
export function StudentGuide({ courseId, data, onClassDetails }: { courseId: string; data: ClassCenterData; onClassDetails: () => void }) {
  ...
  return <div className="space-y-6" data-testid="student-guide">
    <header className="flex flex-wrap items-start justify-between gap-3"><div><h2 className="font-display text-2xl font-extrabold">Guide</h2><p className="mt-1 text-sm text-muted-foreground">What your professor wants you to understand. Your notes guide future notebooks and flashcards.</p></div><Button variant="ghost" onClick={onClassDetails}>Class details</Button></header>
