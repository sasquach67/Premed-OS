...
import { BookOpen, Brain, Check, ChevronDown, CircleHelp, FileCheck2, FilePlus2, FileSearch, FileStack, FileText, FileUp, ListChecks, MoreHorizontal, NotebookText, Search, Sparkles } from 'lucide-react'
