...
export const UNIT_MASTERY_OUTLINE_V1: ArtifactSpec = {
  ...
  outputSchema: {
    type: 'object', required: ['title', 'unit', 'standards'], properties: {
      ...
      standards: { type: 'array', minItems: 1, items: { type: 'object', required: ['id', 'title', 'freeRecallCues', 'understand', 'beAbleToDo', 'watchFor', 'examPractice', 'sourceChunkIds'], properties: {
