 ...
 * deliberately absent — `04` flashcards and `03` study guide arrive in Phases
 * 3 and 4, and `10` reading summaries is still PROPOSED. Registering a spec
 * whose engine does not exist would let the assembler produce a prompt for an
 * artifact nothing can generate.
 */
