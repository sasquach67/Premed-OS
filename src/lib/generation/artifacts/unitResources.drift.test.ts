...
describe('unit resource specs stay synchronized with their Markdown authorities', () => {
  ...
  it('keeps course blueprint defaults and moves visible in the Markdown authority', () => {
    ...
    expect(blueprintSpecDocument).toContain('application, integration, method-and-controls, interpretation, recall')
    ...
    expect(blueprintSpecDocument).toContain('situational, application, interpretation, recall')
