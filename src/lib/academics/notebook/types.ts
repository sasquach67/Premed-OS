...
)) | NotebookFigureBlock | NotebookStudyDiagramBlock
...
export type NotebookPackage = NotebookPackageV2 | (Omit<NotebookPackageV2, 'version' | 'instructionsVersion'> & { version: 3; instructionsVersion: 'notebook-workflows-draft-3'; assets: NotebookAsset[]; visualReview: NotebookVisualReview })
