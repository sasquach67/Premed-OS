...
export function JournalEntryPage() {
  ...
  return <section className="notebook-entry-page w-full min-w-0 space-y-5 px-4 pb-8 pt-2 md:px-8">
    ...
    {entry && <div className="flex justify-end"><Button variant="outline" onClick={() => navigate(`${back}/resources/flashcards?journal=${encodeURIComponent(entry.id)}`)}><Brain aria-hidden="true" />Create flashcards</Button></div>}
