...
export function JournalEntryPage() {
  ...
  return <section className="mx-auto w-full max-w-6xl space-y-5 p-4 sm:p-6">
    ...
    <header><h1 className="font-display text-3xl font-extrabold">{entry ? 'Continue journal entry' : 'Add to journal'}</h1><p className="mt-2 text-muted-foreground">{course.code} · Lecture, readings, or exam prep. Choose what you have and what you want to understand.</p></header>
